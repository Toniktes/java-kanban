...
class HttpTaskServerTest {
    ...
    void getTasksTest() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("task", "des1", TaskStatus.NEW, 1, LocalDateTime.of(2022, 12, 1, 10, 30));
    ...
    void getEpicsTest() {
        ...
        Epic epic = new Epic("epic1", "descriptionEpic1", TaskStatus.NEW, 120, LocalDateTime.of(2022, 12, 3, 10, 30));
    ...
    void getSubtasksTest() {
        ...
        try {
            ...
            if (postResponse.statusCode() == 201) {
                ...
                epic.setId(epicId);
                Subtask subtask = new Subtask("sub1", "des1", TaskStatus.NEW, 120, LocalDateTime.of(2022, 12, 3, 10, 30), epic.getId());
                url = URI.create(SUBTASK_BASE_URL);
    ...
    void getTaskTest() {
        HttpClient client = HttpClient.newHttpClient();
        URI url = URI.create(TASK_BASE_URL);
        Task task = new Task("task1", "des1", TaskStatus.NEW, 1, LocalDateTime.of(2022, 12, 1, 10, 30));
